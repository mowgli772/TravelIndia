...
const Plantrip = () => {
  ...
  return (
    <div className="max-w-md h-screen pt-[150px] text-black mx-auto bg-white shadow-lg rounded-lg p-6">
      {!submitted ? (
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-4">
            ...
            <input
              ...
              className="w-full px-4 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-600 text-white"
              required
            />
          </div>
          <div className="mb-4">
